...
def handle_chatbot_request():
    ...
    if "current time in" in message:
        ...
        response = "The President of United States is Joe Biden."
        ...
        response = "I can understand and respond in multiple languages! I'm proficient in many languages, including but not limited to:<br>" \
                "English <br>"\
                "Spanish<br>"\
                "French<br>"\
                "German<br>"\
